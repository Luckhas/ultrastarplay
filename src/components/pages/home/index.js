      ...
      <section id="faq" className="container-fluid">
        <div className="container">
          <div className="container-fluid text-center">
            ...
            <div className="mt-5">
              <h2>Quer uma dica de como renovar seu RedPlay?</h2>

              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#embededVidTutorial">
                VEJA O TUTORIAL
              </button>

              <div class="modal fade" id="embededVidTutorial" tabindex="-1" aria-labelledby="embededVidTutorialLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="embededVidTutorialLabel">
                        Como Renovar o RedPlay
                      </h5>
                    ...
                    <div class="modal-body">
                      <div class="embed-container">
                        <iframe src="https://www.youtube.com/embed/NemPq5VC_cM" frameborder="0" allowfullscreen="true"></iframe>
                      </div>
                    </div>
